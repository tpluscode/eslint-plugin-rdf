...
```js
import js from "@eslint/js";
import rdf, { configs } from "eslint-plugin-rdf";
...
```js
import { configs } from "eslint-plugin-rdf";
...
| :--- | :--- | :--- |
| `configs.recommended` | `*` | Array containing `[configs.js, configs.rdf, configs.sparql]`. |
| `configs.js` | JS / TS | Recommended rules for JavaScript/TypeScript RDF code (`rdfjs/ban-rdf-js`). |
| `configs.rdf` | `**/*.{ttl,trig,n3,nt,nq}` | Recommended rules and custom parser for RDF documents. |
| `configs.turtle` | `**/*.{ttl,trig,n3}` | Rules tailored for Turtle, TriG, and N3 documents. |
| `configs.ntriples` | `**/*.nt` | Rules tailored for N-Triples line-based files. |
| `configs.nquads` | `**/*.nq` | Rules tailored for N-Quads line-based files. |
| `configs.sparql` | `**/*.{rq,ru,sparql}` | Recommended rules and custom parser for SPARQL queries and updates. |
...
### JavaScript / TypeScript Rules (`rdfjs/*`)

| Rule | Description | 💼 | 🔧 |
| :--- | :--- | :---: | :---: |
| [`rdfjs/ban-rdf-js`](docs/rules/js/ban-rdf-js.md) | Disallow deprecated `rdf-js` package imports in favor of `@rdfjs/types` | 💼 | 🔧 |
...
| Rule | Description | 💼 | 🔧 |
| :--- | :--- | :---: | :---: |
| [`sparql/indentation`](docs/rules/sparql/indentation.md) | Enforce consistent indentation in SPARQL queries and updates | 💼 | 🔧 |
| [`sparql/keyword-case`](docs/rules/sparql/keyword-case.md) | Enforce consistent casing for SPARQL keywords | 💼 | 🔧 |
| [`sparql/known-terms`](docs/rules/sparql/known-terms.md) | Verify that terms from known vocabularies actually exist | 💼 | |
| [`sparql/max-empty-lines`](docs/rules/sparql/max-empty-lines.md) | Enforce a maximum number of consecutive empty lines | 💼 | 🔧 |
| [`sparql/no-duplicate-prefixes`](docs/rules/sparql/no-duplicate-prefixes.md) | Disallow duplicate prefix declarations | 💼 | |
| [`sparql/no-undeclared-prefixes`](docs/rules/sparql/no-undeclared-prefixes.md) | Disallow the use of undeclared prefixes | 💼 | 🔧 |
| [`sparql/no-unused-prefixes`](docs/rules/sparql/no-unused-prefixes.md) | Disallow unused prefix declarations | 💼 | 🔧 |
| [`sparql/predicate-per-line`](docs/rules/sparql/predicate-per-line.md) | Enforce placement of each predicate on a new line in SPARQL patterns | 💼 | 🔧 |
| [`sparql/prefer-prefixed-names`](docs/rules/sparql/prefer-prefixed-names.md) | Enforce using prefixed names instead of full URIs | 💼 | 🔧 |
| [`sparql/prefix-name-case`](docs/rules/sparql/prefix-name-case.md) | Enforce consistent naming case for prefixes | 💼 | 🔧 |
| [`sparql/semicolon-spacing`](docs/rules/sparql/semicolon-spacing.md) | Enforce spacing before semicolons (`;`) | 💼 | 🔧 |
| [`sparql/sort-prefixes`](docs/rules/sparql/sort-prefixes.md) | Require prefix declarations to be sorted alphabetically | 💼 | 🔧 |
